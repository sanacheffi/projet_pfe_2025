  ...
  return (
    ...
    <nav className="container mx-auto flex items-center justify-between py-4 px-2">
        ...
        <div className="hidden lg:flex space-x-10">
            <Link to="/collections/all?collection=Meubles Rotin" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Meubles Rotin 
            </Link>
            <Link to="/collections/all?collection=Luminaires Rotin" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Luminaires Rotin
            </Link>
            <Link to="/collections/all?collection=Objets de Décoration" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Objets de Décoration 
            </Link>
            <Link to="/collections/all?collection=Décorations Murales" className="text-gray-700 hover:text-black text-sm font-medium uppercase">
            Décorations Murales 
            </Link>
        </div>
    ...
    <div className="flex justify-end p-4">
        <button>
            <IoMdClose onClick={toggleNavDrawer} className="h-6 w-6 text-gray-600 hover:text-black"/>
        </button>
    </div>
    <div className="p-4">
